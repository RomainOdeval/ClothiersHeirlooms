...
namespace ClothierHeirloomsmod.NSBlockEntity
{
    ...
    {
        public int inputnum => ClothierHeirloomsmodModSystem.Config?.SpinnerInput ?? 3;
        public int outputnum => ClothierHeirloomsmodModSystem.Config?.SpinnerOutput ?? 2;
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            if (api.Side == EnumAppSide.Client)
            {
                ...
                animUtil?.InitializeAnimator("clothierheirloomsmod:block/spinner", null, null, new Vec3f(0, rotY, 0));
            }
        }
