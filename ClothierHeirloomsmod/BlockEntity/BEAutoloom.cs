...
namespace ClothierHeirloomsmod.NSBlockEntity
{
    public class BlockEntityAutoloom : BlockEntityOpenableContainer
    {

        public int inputnum = ClothierHeirloomsmodModSystem.Config?.LoomInput ?? 3;
        public int outputnum = ClothierHeirloomsmodModSystem.Config?.LoomOutput ?? 2;
        ...
        public override void Initialize(ICoreAPI api)
        {
            ...
            if (api.Side == EnumAppSide.Client)
            {
                ...
                animUtil?.InitializeAnimator("clothierheirloomsmod:block/autoloom", null, null, new Vec3f(0, rotY, 0));
        ...
        internal MeshData GenAxleMesh()
        {
            ...
            MeshData modelData;
            ((ICoreClientAPI)Api).Tesselator.TesselateShape(block, Shape.TryGet(Api, "clothierheirloomsmod:shapes/block/autoloom-axle.json"), out modelData);
            return modelData;
        }
...
/*        public override bool OnTesselation(ITerrainMeshPool mesher, ITesselatorAPI tessThreadTesselator)
        ...
        internal MeshData GenMesh(string type = "base")
        {
            ...
            ((ICoreClientAPI)Api).Tesselator.TesselateShape(block, Shape.TryGet(Api, "clothierheirloomsmod:shapes/block/autoloom.json"), out var modeldata);
            return modeldata;
        }
*/
